...
#include <vector>                 // memset, memmove, memcpy, strlen, strchr, strcpy, strcmp
...
namespace ImGui
{
    ...
    IMGUI_API bool          ButtonCustom(const char* label, const ImVec2& size = ImVec2(0, 0));   // button
    ...
    IMGUI_API bool          Dropdown(const char* label, int* current_item, const char* const items[], int items_count);
    IMGUI_API bool          DropdownValue(const char* label, int* current_item, const char* const items[], int items_count);

    IMGUI_API bool          DropdownMultiLabel(const char* label, std::vector<bool>* current_items, const char* const items[], int items_count);
    IMGUI_API bool          DropdownMulti(const char* label, std::vector<bool>* current_items, const char* const items[], int items_count);
